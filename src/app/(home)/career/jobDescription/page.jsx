...
const JobDescription = () => {
  return (
    <section className="container py-14 max-w-full w-full font-ibm flex justify-center items-center">
      <div className="max-w-screen-xl">
        <div className="flex flex-col lg:flex-row gap-4">
          <div className="">
            <h1 className="text-xl lg:text-2xl font-bold mb-4">Lorem Ipsum</h1>
            <h2 className="text-md lg:text-lg mb-1">
              At Igire Rwanda Organization
            </h2>
            <h2 className="text-md lg:text-lg mb-4 text-gray-500">
              Kigali, Rwanda
            </h2>
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                ...
                dolor sit amet, consectetur adipiscing elit. Praesent euismod
                elit eu eros fringilla, a placerat ex vehicula.
              </p>
            </div>
